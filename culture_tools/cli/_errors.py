...
Every failure inside culture-tools raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`culture_tools.cli._output`,
...
# Exit-code policy. Documented in ``culture-tools learn`` output.
# 0      = success
