...
from culture_tools.cli._errors import EXIT_USER_ERROR, CliError
from culture_tools.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/culture-tools/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = _CliArgumentParser(
        prog="culture-tools",
        description="culture-tools — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
