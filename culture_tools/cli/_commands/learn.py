"""``culture-tools learn`` — the learnability affordance.
...
from culture_tools.cli._output import emit_result

_TEXT = """\
culture-tools — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  culture-tools whoami             Identity from culture.yaml.
  culture-tools learn              This self-teaching prompt.
  culture-tools explain <path>...  Markdown docs for any noun/verb path.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "culture-tools explain <path>",
    }
