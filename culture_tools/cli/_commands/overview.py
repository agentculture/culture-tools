"""``culture-tools overview`` — read-only descriptive snapshot of the agent.
...
:mod:`culture_tools.cli._commands.cli`).
...
from culture_tools.cli._commands.whoami import report
...
_VERBS = [
    ...
    "index check — run the AgentFront conformance gate over the tool index",
]
