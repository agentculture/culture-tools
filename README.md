...
uv run culture-tools whoami  # identity from culture.yaml
uv run culture-tools learn   # self-teaching prompt (add --json)
...
1. Rename the package `culture_tools/` and the `culture-tools`
